...
class SettingsLoader():
    def load_all_settings(paths):
        ...
        return {
            ...
            "backtester_settings":{
                "signals": SignalParser.parse_signal_file(paths["signals"], trader_settings["optimize"]),
                "strategies": StrategyParser.parse_strategies_from_file(paths["strategies"], trader_settings["optimize"]),
