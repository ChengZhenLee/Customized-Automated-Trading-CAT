...
class Validator():
    def validate_signal_params(signal_names, all_signal_params, all_signal_optimize_params, optimize):
    ...
    def validate_strategy_params(strategy_names, all_strategy_params, all_strategy_optimize_params, optimize):
