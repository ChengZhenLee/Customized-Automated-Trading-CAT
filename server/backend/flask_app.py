...
def get_backtester_results(task_id):
    ...
    if task_result.successful():
        ...
        # If the log file doesnt exist, results were already retrieved and cleaned up
            ...
            return jsonify({"status": "retrieved", 
                            "message": f"Result for task {task_id} already retrieved and cleaned up."
                            }), 200
    ...
    # the task is still pending
        ...
        return jsonify({"status": "pending", 
                        "message": f"Task {task_id} is still pending or doesn not exist"
                        }), 200  